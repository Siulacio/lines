...
<x-layouts.app title="Edit" meta-description="Edit Meta Description">
    ...
    <h1 class="my-4 font-serif text-3xl text-center text-sky-600 dark:text-sky-500" >USER EDITION FORM</h1><br>



    <h4><form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('employees.update', $employee) }}" method="POST">
            @csrf @method('PATCH')
